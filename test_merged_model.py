...
# Configuration
MERGED_MODEL_PATH = "./whisper-hindi-cv-merged"
...
def evaluate_model():
    ...
    try:
        processor = WhisperProcessor.from_pretrained(MERGED_MODEL_PATH, language="hindi", task="transcribe")
    ...
    for i, item in enumerate(dataset):
        ...
        with torch.no_grad():
            generated_ids = model.generate(input_features, language="hindi", task="transcribe")
    ...
    print(f"\n📊 Final WER for Merged Model: {wer:.2f}%")
